    ...
    <div className="biografia">
      ...
      <div className="contenido">
        ...
        <div className="item derecha">
          <img src={imagen1} className="imagen" alt="Imagen 1" />
        </div>
        <div className="item derecha">
          <p className="texto">
        ...
        <div className="item izquierda">
          <img src={imagen2} className="imagen" alt="Imagen 2" />
        </div>
        <div className="item izquierda">
          <p className="texto">
        ...
        <div className="item derecha">
          <img src={imagen3} className="imagen" alt="Imagen 3" />
        </div>
        <div className="item derecha">
          <p className="texto">
        ...
        <div className="item izquierda">
          <img src={imagen4} className="imagen" alt="Imagen 4" />
        </div>
      </div>
    </div>
  </Layout>
