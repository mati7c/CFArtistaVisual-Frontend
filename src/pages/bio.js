        ...
        <div className="fila">
          <div className="texto">
            <p>
              ...
              “Diálogos Pictóricos” muestra individual en Espacio Marcantoni Arte, Río Ceballos, en Diciembre de 2024 “Atravesar el Paisaje” (individual) en Museo De La Ciudad Luis Biondi, Jesús María, Muestra Colectiva en Espacio Uq Bar de la ciudad de Unquillo. Y una de las últimas muestras desde  Ocubre 2025 hasta Febrero 2026 “Espesores del Tiempo” Parte 1, muestra colectiva en  el MUMU, ciudad de Córdoba, en el marco de la Especialización en Producción Artística Contemporánea de la Facultad de Artes de la UNC. 
            </p>
          </div>
          <div className="imagen">
